 ...
 */
+ (id)initSystemPlayerWithFileName:(NSString *)fileName
{
    SoundPlayer *player = [[SoundPlayer alloc] init];
 ...
 */
+ (id)initPlayerWithFileName:(NSString *)fileName
{
    SoundPlayer *player = [[SoundPlayer alloc] init];
...
{
    unsigned long ID = soundId; // soundId 不能直接作为参数打印出来，需要中转一次
